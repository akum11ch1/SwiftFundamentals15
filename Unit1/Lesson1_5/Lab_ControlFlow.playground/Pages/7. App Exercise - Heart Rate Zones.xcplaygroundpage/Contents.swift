...
case 141...160:
    print("You are in the Moderate zone. Activity in this zone helps with aerobic fitness.")
case 161...180:
    print("You are in the Hard zone. Activity in this zone increases maximum performance capacity for shorter sessions.")
case 181...200:
    print("You are in the Maximum zone. Activity in this zone helps fits athletes develop speed")
default:
    print("Slow down!")
}
