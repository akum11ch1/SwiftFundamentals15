 ...
 */
let nameInCaps = "LaShae"
let name = "lashae"
if nameInCaps == name {
    print("The two stringd are equal.")
} else {
...
if nameInCaps.lowercased() == name {
    ...
    print(print("\(nameInCaps.lowercased()) and \(name.lowercased()) are not the same."))
}
...
let textToSearch = textToSearchThrough.lowercased()
